...
_semicolon,     _Q,         _W,      _F,      _P,    _G,   _del,
    _tab,   _A,         _R,      _S,      _T,    _D,
...
_enter, _K,      _M,  _comma, _period,     _slash,   _shiftR,
...
// left hand
  ...
  0,  _grave,  _bracketL,        _9, _bracketL,  _bracketL,    1,
  0,      _1,         _7,        _0, _bracketR,  _bracketR,
...
// left hand
 ...
 ktrans, sshprre, sshprre, sshprre, kprrel,sshprre,
